...
;
INSERT INTO counter.settings (id, setting_type_alias, value, parent_id) VALUES (DEFAULT, 'factory', 'Factory 1', NULL);
INSERT INTO counter.settings (id, setting_type_alias, value, parent_id) VALUES (DEFAULT, 'machine', 'Machine 1', 1);
INSERT INTO counter.settings (id, setting_type_alias, value, parent_id) VALUES (DEFAULT, 'buyer', 'Buyer Test', NULL);
